...
include_once('config.php');
    ...
    $view = "SELECT * FROM products WHERE genero = 'masc'";
...
$view = "SELECT * FROM products WHERE genero = 'fem'";
$resp = $conn -> query($view);
...
$view = "SELECT * FROM products WHERE genero = 'inf'";
$resp = $conn -> query($view);
...
<div class="test">
   ...
   <div class="price_container">
       <?php echo $viewp['estq'] ?>
        ...
        <a href="http://localhost/Zz/products/<?php echo $viewp['nome'] ?>?id=<?php echo $viewp['id'] ?>"><input type="submit" name="buy" value="Comprar" class="<?php echo $nomeprod ?>" class="cmp"></a>
...
if(isset($_POST['buy_'.$nomegeral[0]])){
    $w = "UPDATE products SET estq = estq - 1 WHERE nome = '$nomeprod'";
    $a = $conn -> query($w);
